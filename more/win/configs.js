YL.static = {
  /** “关于”信息 */
  softwareName: 'Steven的博客', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: 'Steven',//作者
  contactInformation: '1066106590@qq.com',//联系方式
  officialWebsite: 'https://blog.steven.tk',//软件官网
  welcome: '欢迎来到Steven的博客',//加载完毕控制台提示信息
